...
service whenever interfaces go up/down, VPNs toggle, or DHCP refreshes. The
reload rebinds listeners without flushing in-memory caches so responses stay
warm after roaming between Wi-Fi or other networks.
